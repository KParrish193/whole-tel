      ...
      <form>
        <div className={styles["form-left"]}>
          ...
          <p className={styles["contact-paragraph"]} style={figtree.style}>
            If you have any questions or would like to inquire about booking our
            properties, we're here to assist you. Simply fill out the form, and
            our team will get back to you promptly. We strive to make your
            booking experience seamless and look forward to helping you find the
            perfect location for your event. Get in touch with us today!
          </p>
